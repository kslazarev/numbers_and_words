...
describe Integer do
  ...
  describe 'ones' do
    context '0 as uniq example' do
      subject { 0 }
      its(:to_words) { should == I18n.t('.numbers.ones_male')[0] }
    end

    context '1 as lower example' do
      subject { 1 }
      its(:to_words) { should == I18n.t('.numbers.ones_male')[1] }
    end

    context '9 as upper example' do
      subject { 9 }
      its(:to_words) { should == I18n.t('.numbers.ones_male')[9] }
    end
  end
  ...
  describe 'teens' do
    context '10 as uniq example' do
      subject { 10 }
      its(:to_words) { should == I18n.t('.numbers.teens')[0] }
    end
