...
describe Integer do
  ...
  [ 
    ...
    {
      :trillions => [
        [ 2935174315119, "два триллионa девятьсот тридцать пять миллиардов сто семьдесят четыре миллиона триста пятнадцать тысяч сто девятнадцать" ],
      ]
    }
  ].each do |ctx|
