...
Gem::Specification.new do |s|
  ...
  s.files = [%q{lib/locales}, %q{lib/locales/integer.ru.yml}, %q{lib/locales/plurals.rb}, %q{lib/number_to_words_ru}, %q{lib/number_to_words_ru/integer.rb}, %q{lib/number_to_words_ru.rb}]
