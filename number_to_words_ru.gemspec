...
Gem::Specification.new do |s|
  ...
  s.files = [%q{lib/locales}, %q{lib/locales/numbers.ru.yml}, %q{lib/locales/plurals.rb}, %q{lib/number_to_words_ru}, %q{lib/number_to_words_ru/array_additions.rb}, %q{lib/number_to_words_ru/integer.rb}, %q{lib/number_to_words_ru.rb}, %q{spec/number_to_words_ru}, %q{spec/number_to_words_ru/ru_spec.rb}, %q{spec/spec_helper.rb}]
