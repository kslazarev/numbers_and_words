...
Простой перевод чисел в слова при помощи библиотеки I18n.
...
Страница number_to_words на github -- "http://github.com/kslazarev/number_to_words_ru":http://github.com/kslazarev/number_to_words_ru
...
* "Кирилл Лазарев" ("k.s.lazarev@gmail.com":mailto:k.s.lazarev@gmail.com)
