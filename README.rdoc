...
Przeliteruj liczby w kilku językach za pomocą gemu I18n.
...
== Examples / Примеры / Exemples
    ...
    18n.with_locale(:pl) { 42.to_words }
    => "czterdzieści dwa"
...
* Polish
  ...
  Change gender form: (gender: [:female || :male || :neuter])
    ...
    I18n.with_locale(:pl) { 1.to_words gender: :female }
    => "jedna"

    I18n.with_locale(:pl) { 1.to_words gender: :male }
    => "jeden"

    I18n.with_locale(:pl) { 1.to_words gender: :neuter }
    => "jedno"
